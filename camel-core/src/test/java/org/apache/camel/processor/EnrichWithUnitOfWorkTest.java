...
public class EnrichWithUnitOfWorkTest extends ContextTestSupport {
    ...
    public void testEnrichWith() throws Exception {
        ...
        Assertions.assertThat(out.isFailed()).isFalse();
        Assertions.assertThat(out.getMessage().getBody()).isEqualTo("Done Bye World");
    }
    ...
    public void testEnrichWithShareUnitOfWork() throws Exception {
        ...
        Assertions.assertThat(out.isFailed()).isFalse();
        Assertions.assertThat(out.getMessage().getBody()).isEqualTo("Done Bye World"); //, out.getMessage().getBody());
    }
