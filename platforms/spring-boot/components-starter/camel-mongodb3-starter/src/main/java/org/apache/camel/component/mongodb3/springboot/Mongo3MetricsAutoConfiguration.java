...
@AutoConfigureBefore({MongoMetricsAutoConfiguration.class, MongoAutoConfiguration.class})
@AutoConfigureAfter({ MetricsAutoConfiguration.class, CompositeMeterRegistryAutoConfiguration.class })
@ConditionalOnClass(MongoClientSettings.class)
@ConditionalOnBean(MeterRegistry.class)
@AutoConfigureOrder(Ordered.HIGHEST_PRECEDENCE)
public class Mongo3MetricsAutoConfiguration {
    ...
    @ConditionalOnClass(Mongo3MetricsConnectionPoolListener.class)
    ...
    static class MongoConnectionPoolMetricsConfiguration {
        ...
        @Bean
        @ConditionalOnMissingBean
        Mongo3MetricsConnectionPoolListener mongoMetricsConnectionPoolListener(MeterRegistry meterRegistry,
                                                                              Mongo3ConnectionPoolTagsProvider mongoConnectionPoolTagsProvider) {
            return new Mongo3MetricsConnectionPoolListener(meterRegistry, mongoConnectionPoolTagsProvider);
        }

        @Bean
        @ConditionalOnMissingBean
        Mongo3ConnectionPoolTagsProvider mongoConnectionPoolTagsProvider() {
            return new DefaultMongo3ConnectionPoolTagsProvider();
        }

        @Bean
        MongoClientSettingsBuilderCustomizer mongoMetricsConnectionPoolListenerClientSettingsBuilderCustomizer(Mongo3MetricsConnectionPoolListener mongoMetricsConnectionPoolListener) {
