...
| *artemisStreamingEnabled* (advanced) | Whether optimizing for Apache Artemis streaming mode. | false | boolean
...
The component supports 176 options, which are listed below.
...
| *camel.component.jms.artemis-streaming-enabled* | Whether optimizing for Apache Artemis streaming mode. | false | Boolean
...
| *camel.component.jms.configuration.artemis-streaming-enabled* | Whether optimizing for Apache Artemis streaming mode. | true | Boolean
