...
public class ByteArray {
  ...
  public byte getitem(int index) {
    return msmq_native_supportJNI.ByteArray_getitem(swigCPtr, index);
  }

  public void setitem(int index, byte value) {
    msmq_native_supportJNI.ByteArray_setitem(swigCPtr, index, value);
  }

  public SWIGTYPE_p_signed_char cast() {
    long cPtr = msmq_native_supportJNI.ByteArray_cast(swigCPtr);
