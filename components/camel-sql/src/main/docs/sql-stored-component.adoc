...
The SQL Stored Procedure component supports 1 options which are listed below.
...
The SQL Stored Procedure component supports 8 endpoint options which are listed below:
