...
public class SqsComponentIntegrationTest extends CamelTestSupport {
    ...
    public static void deleteQueues() {
        SQSIntegrationTestHelper.deleteQueues("MyNewCamelQueue");
    }
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        final String sqsEndpointUri = String.format("aws-sqs://MyNewCamelQueue?%s&messageRetentionPeriod=%s&maximumMessageSize=%s"
                        + "&visibilityTimeout=%s&policy=%s&autoCreateQueue=true",
                SQSIntegrationTestHelper.urlCredentials(), "1209600", "65536", "60", "%7B%22Version%22%3A%222008-10-17%22%2C%22Id%22%3A%22%2F195004372649%2FMyNewCamelQueue%2FSQSDefaultPolicy%22%2C%22"
