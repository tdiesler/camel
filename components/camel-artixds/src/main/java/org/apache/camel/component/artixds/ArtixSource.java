 ...
 */
public class ArtixSource<T extends ArtixSource> implements Processor {
    private Element element;
    private Source source;

    public static ArtixSource artixSource(String modelClassName) {
        try {
    ...
    public static ArtixSource artixSource(Class<?> elementType) {
        try {
    ...
    public static ArtixSource artixSource(Element element) {
        return new ArtixSource(element);
    }

    public ArtixSource() {
    }

    public ArtixSource(Element element) {
