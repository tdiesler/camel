...
// components: START
Number of Components: 344 in 265 JAR artifacts (21 deprecated)
...
| link:camel-atlasmap/src/main/docs/atlasmap-component.adoc[AtlasMap] (camel-atlasmap) +
...
`json-patch:resourceUri` | 3.12 | JsonPatch component which transform JSON using JSON patch (RFC 6902).
...
| link:camel-kamelet-reify/src/main/docs/kamelet-reify-component.adoc[Kamelet Reify] (camel-kamelet-reify) +
...
| link:camel-resteasy/src/main/docs/resteasy-component.adoc[Resteasy] (camel-resteasy) +
...
// dataformats: START
Number of Data Formats: 58 in 47 JAR artifacts (4 deprecated)

[width="100%",cols="4,1,5",options="header"]
|===
| Data Format | Available From | Description

| link:camel-any23/src/main/docs/any23-dataformat.adoc[Any23] (camel-any23) | 3.0 | Extract RDF data from HTML documents.
...
| link:camel-jackson-avro/src/main/docs/avro-jackson-dataformat.adoc[Avro Jackson] (camel-jackson-avro) | 3.10 | Marshal POJOs to Avro and back using Jackson.
...
| link:camel-jsonb/src/main/docs/json-jsonb-dataformat.adoc[JSON JSON-B] (camel-jsonb) | 3.7 | Marshal POJOs to JSON and back using JSON-B.
...
| link:camel-jackson-protobuf/src/main/docs/protobuf-jackson-dataformat.adoc[Protobuf Jackson] (camel-jackson-protobuf) | 3.10 | Marshal POJOs to Protobuf and back using Jackson.
...
| link:camel-zip-deflater/src/main/docs/zipdeflater-dataformat.adoc[Zip Deflate Compression] (camel-zip-deflater) | 2.12 | Compress and decompress streams using java.util.zip.Deflater and java.util.zip.Inflater.
...
// languages: START
Number of Languages: 26 in 16 JAR artifacts (6 deprecated)
...
// others: START
Number of Miscellaneous Components: 66 in 66 JAR artifacts (14 deprecated)
...
| link:camel-caffeine-lrucache/src/main/docs/caffeine-lrucache.adoc[Caffeine Lrucache] (camel-caffeine-lrucache) | 3.0 | *deprecated* Camel Caffeine LRUCache support
...
| link:camel-elytron/src/main/docs/elytron.adoc[Elytron] (camel-elytron) | 3.1 | Elytron Security Provider for camel-undertow

| link:camel-etcd3/src/main/docs/etcd3.adoc[Etcd3] (camel-etcd3) | 3.5 | Aggregation repository using EtcD as datastore
...
| link:camel-leveldb-legacy/src/main/docs/leveldb-legacy.adoc[LevelDB-legacy] (camel-leveldb-legacy) | 2.10 | Using LevelDB as persistent EIP store
