...
public class JaxWSCamelConduitTest extends JaxWSCamelTestSupport {
    ...
    public void testLoggingFeature() {
        ...
        clientBean.setAddress("camel://direct:start2");
        clientBean.setServiceClass(SampleWS.class);
        clientBean.setBus(BusFactory.getThreadDefaultBus());
        proxyFactory.getFeatures().add(new LoggingFeature());
        proxyFactory.create(SampleWS.class).getSomething();
    }
}
