...
* *bulk2GetAllJobs* -- Gets information about all jobs in the org. The information includes Bulk API 2.0 jobs and all Bulk API jobs. Response body is an instance of `Jobs`. If the `done` property
...
* *bulk2GetAllQueryJobs* - Gets information about all query jobs in the org. The information includes Bulk API 2.0 query jobs and all Bulk API jobs. Response body is an instance of `QueryJobs`. If the `done`
...
| *concurrencyMode* (common) | Gets information only about jobs matching the specified concurrency mode. Possible values are 'serial' and 'parallel'. Supported in bulk2GetAllQueryJobs, ignored elsewhere. |  | String
...
| *isPkChunkingEnabled* (common) | If set to true, filters jobs with PK chunking enabled. Supported in bulk2GetAllJobs and bulk2GetAllQueryJobs, ignored elsewhere. |  | String
| *jobId* (common) | Bulk API Job ID |  | String
| *jobType* (common) | Filters jobs based on job type. Valid values include: BigObjectIngest BigObjects job, Classic Bulk API 1.0 job, V2Ingest Bulk API 2.0 job, V2Query Bulk API 2.0 query jobs. Supported in bulk2GetAllJobs and bulk2GetAllQueryJobs, ignored elsewhere. |  | String
...
| *locator* (common) | Gets a specific set of results. If this is omitted, the request returns as many rows as can be listed. If there are more results than can be listed, the Sforce-Locator header contains a locator value to get the next set of results. Supported in bulk2GetQueryJobResults, ignored elsewhere. |  | String
...
| *maxRecords* (common) | The maximum number of records to retrieve per set. The request is still subject to the size limits. If you are working with very large query result sets, you may experience a timeout before receiving all the data from Salesforce. To prevent a timeout, specify the maximum number of records your client is expecting to receive by in the maxRecords parameter. This splits the results into smaller sets. Supported in bulk2GetQueryJobResults, ignored elsewhere. |  | String
...
| *camel.component.salesforce.config.concurrency-mode* | Gets information only about jobs matching the specified concurrency mode. Possible values are 'serial' and 'parallel'. Supported in bulk2GetAllQueryJobs, ignored elsewhere. |  | String
...
| *camel.component.salesforce.config.is-pk-chunking-enabled* | If set to true, filters jobs with PK chunking enabled. Supported in bulk2GetAllJobs and bulk2GetAllQueryJobs, ignored elsewhere. |  | String
| *camel.component.salesforce.config.job-id* | Bulk API Job ID |  | String
| *camel.component.salesforce.config.job-type* | Filters jobs based on job type. Valid values include: BigObjectIngest BigObjects job, Classic Bulk API 1.0 job, V2Ingest Bulk API 2.0 job, V2Query Bulk API 2.0 query jobs. Supported in bulk2GetAllJobs and bulk2GetAllQueryJobs, ignored elsewhere. |  | String
...
| *camel.component.salesforce.config.locator* | Gets a specific set of results. If this is omitted, the request returns as many rows as can be listed. If there are more results than can be listed, the Sforce-Locator header contains a locator value to get the next set of results. Supported in bulk2GetQueryJobResults, ignored elsewhere. |  | String
...
| *camel.component.salesforce.config.max-records* | The maximum number of records to retrieve per set. The request is still subject to the size limits. If you are working with very large query result sets, you may experience a timeout before receiving all the data from Salesforce. To prevent a timeout, specify the maximum number of records your client is expecting to receive by in the maxRecords parameter. This splits the results into smaller sets. Supported in bulk2GetQueryJobResults, ignored elsewhere. |  | String
